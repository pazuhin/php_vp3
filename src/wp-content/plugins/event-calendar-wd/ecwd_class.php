...
class ECWD {
    ...
    private function __construct() {
		...
		add_action('elementor/editor/after_enqueue_styles', array($this, 'enqueue_elementor_widget_styles'), 11);
    }
  ...
  /**
	...
	*/
	...
	function enqueue_elementor_widget_styles() {
		wp_enqueue_style('twbb-editor-styles', ECWD_URL . '/css/elementor_style.css', array(), '1.0.0');
	}
}
