    ...
    <header class="main-header">
            ...
            <div class="top-header__wrap">
                ...
                <nav class="main-navigation">
                    <ul class="nav-list">
                        ...
                        <li class="nav-list__nav-item"><a href="/src/wp-content/themes/loft/akcii.php" class="nav-list__nav-item__nav-link">Последние акции</a></li>
                        <li class="nav-list__nav-item"><a href="/src/wp-content/themes/loft/info.php" class="nav-list__nav-item__nav-link">О сервисе</a></li>
        ...
        <div class="bottom-header">
            <div class="search-form-wrap">
                <form class="search-form" method="get" action="/src">
